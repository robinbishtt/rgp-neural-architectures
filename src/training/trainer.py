...
Main training loop with mixed precision, gradient clipping, callbacks,
NaN recovery, checkpoint save/resume, and telemetry logging.
"""
...
class Trainer:
    """
    Generic trainer for RG-Net models.
