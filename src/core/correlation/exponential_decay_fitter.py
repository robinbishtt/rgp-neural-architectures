...
class ExponentialDecayFitter:
    ...
    def fit(
        ...
        Accepts two call signatures:
          fit(xi_values)            - layers auto-generated as 0, 1, ..., N-1
          fit(layers, xi_values)    - explicit layer indices

        Args:
            layers_or_xi: layer indices OR xi_values array (if xi_values is None)
            xi_values:    measured correlation lengths (optional, see above)
