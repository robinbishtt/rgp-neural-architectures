"""
src/architectures/baselines/resnet_baseline.py

ResNet baseline for H3 comparative evaluation.
"""
...
class ResNetBaseline(nn.Module):
    """ResNet-style MLP baseline with residual connections. Standard Kaiming init."""
