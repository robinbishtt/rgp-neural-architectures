"""
src/checkpoint/rng_serializer.py

RNGStateSerializer: saves/loads all random number generator states via SeedRegistry.
"""
...
class RNGStateSerializer:
    """Serializes all RNG states to rng_state.pkl for exact resume."""
