...
Panel layout:
  ...
  b) RG coarse-graining cartoon: field theory → neural network correspondence
  c) Correlation-length decay ξ(k) schematic across layers

Usage
-----
    python figures/manuscript/generate_figure1.py --output figures/out/fig1.pdf
    python figures/manuscript/generate_figure1.py --fast-track
"""
