...
def _panel_raw_curves(ax: plt.Axes, data: Dict, fast_track: bool) -> None:
    ...
    ax.set_title("Raw curves (before collapse)" + tag, fontsize=7, pad=3)
...
def _panel_residuals(ax: plt.Axes, data: Dict) -> None:
    ...
    ax.set_title("Collapse residuals", fontsize=7, pad=3)
    remove_top_right_spines(ax)
def _panel_nu_bootstrap(ax: plt.Axes, data: Dict) -> None:
    ...
    ax.set_title("Bootstrap distribution of ν", fontsize=7, pad=3)
